// PLACEHOLDER — Commit 4 fills in the real About page (origin story,
// coach-first mission, team, etc.) per the Boostr mockup. Foundation
// stub: header + centered "coming soon" + CTA + footer.
      ...
      >
        <div className="flex flex-col items-center gap-4 max-w-2xl">
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', color: '#c8c8c8' }}>
            Real About page copy lands in Commit 4.
          </p>
        </div>
      </main>
      <ReadyToMaximize />
